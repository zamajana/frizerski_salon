...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="col-xs-12">
                        ...
                        if (isset($_GET["id"])) {
                            $idArtikla = $_GET["id"];
                            $upit = "DELETE FROM prodaja WHERE ID = ".$idArtikla;
                            if (mysqli_query($baza, $upit)) {
                                echo "<p> Uspešno ste obrisali artikal.</p>";
                                echo "<br>";
                            } else {
                                echo "<p> Dogodila se greška prilikom brisanja artikla.</p>";
                            }
                        }
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            $upit="SELECT ID, naziv, cena, kolicina FROM prodaja";
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <input name="param" class="form-control" id="paramInput" placeholder="Unesite naziv artikla"
                                    onkeyup="pronadjiArtikal(paramInput.value)">
                                </div>

                            </div>
                        </div>
                        <div id="artikliRezultat" class="box-body table-responsive">
        ...
        <!-- page script -->
        <script src="../ajax/artikliPretraga.js" type="text/javascript"></script> 
