...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Pretraga klijenata</title>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="col-xs-12">
                        ...
                        if (isset($_GET["id"])) {
                            $idKlijenta = $_GET["id"];
                            $upit = "DELETE FROM klijent WHERE ID = ".$idKlijenta;
                            if (mysqli_query($baza, $upit)) {
                                echo "<p> Uspešno ste obrisali klijenta.</p>";
                                echo "<br>";
                            } else {
                                echo "<p> Dogodila se greška prilikom brisanja klijenta.</p>";
                            }
                        }
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            $upit="SELECT ID, ime, prezime, datumRodj, tel FROM klijent";
                            ...
                            ?>
                             <div class="box-body">
                                        <div class="form-group">
                                            <input name="param" class="form-control" id="paramInput" placeholder="Unesite parametar pretrage (ime, prezime ili telefon)"
                                            onkeyup="pronadjiKlijenta(paramInput.value)">
                                        </div>

                                    </div>
                        </div>
                        <div id="klijentiRezultat" class="box-body table-responsive">
        ...
        <!-- page script -->
         <script src="../ajax/klijentiPretraga.js" type="text/javascript"></script> 
