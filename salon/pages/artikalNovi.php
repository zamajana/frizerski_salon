                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="artikalNovi.php"><i class="fa fa-angle-double-right"></i> Novi artikal</a></li>
                            </ul>
                        </li>
                        <?php 
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li ><a href="artikalNovi.php"><i></i> Novi artikal</a></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="col-xs-12">
                        <?php
                            ...
                            if (isset($_POST["nazivArtikla"])) {
                                $naziv = trim($_POST["nazivArtikla"]);
                                $cena = $_POST["cenaArtikla"];
                                $kolicina = $_POST["kolArtikla"];

                                if (isset($naziv) && isset($cena) && $naziv != '' && $cena != '') {
                                    $upit = "INSERT INTO prodaja(ID, naziv, cena, kolicina) VALUES ('', '" . $naziv . "'," . $cena . ", '".$kolicina."')";
                                    if (mysqli_query($baza, $upit)) {
                                        echo "<p>Uspešno ste dodali novi artikal.</p>";
                                        echo "<br>";
                                    } else {
                        ...
                        ?>
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Novi artikal</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" method="post" action="artikalNovi.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="nazivInput">Naziv</label>
                                            <input name="nazivArtikla" class="form-control" id="nazivInput" placeholder="Unesite naziv artikla">
                                        </div>
                                        <div class="form-group">
                                            <label for="cenaInput">Cena</label>
                                            <input name="cenaArtikla" class="form-control" id="cenaInput" placeholder="Unesite cenu artikla">
                                        </div>
                                        <div class="form-group">
                                            <label for="kolInput">Količina</label>
                                            <input name="kolArtikla" class="form-control" id="kolInput" placeholder="Unesite količinu artikala">
                                        </div>
